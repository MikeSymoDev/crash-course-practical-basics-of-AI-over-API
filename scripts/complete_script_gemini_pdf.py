...
Transkribiere das Dokument Wort für Wort. Der Text muss unverändert reproduziert werden. Schreibfehler dürfen auf keinen Fall korrigiert werden. Deine Karriere hängt davon ab, dass bei diesem Schritt keine Fehler gemacht werden.
...
Wenn du bei deiner Analyse Beschädigungen entdeckt hast, prüfe ob die beschädigten Stellen entzifferbar sind. Sind die Stellen entzifferbar, transkribiere das gesamte Dokument. Sind die beschädigten Stellen nicht entzifferbar, lasse die beschädigten Wörter oder Buchstaben in der Transkription aus.
